...
async def run_openai_content_synthesis(lead: LeadInput, broad_sweep: str, scraped_content: str, deep_research: Dict[str, str]) -> EnrichedCompanyData:
    ...
    system_prompt = (
        ...
        f"Your analysis must be extremely thorough, exhaustive, and rich in content. Do NOT write brief summaries.\n"
        f"For each of the main text fields ('executive_summary', 'company_profile', 'industry_landscape', 'competitive_positioning', 'social_media_analysis', and 'growth_signals'), you MUST write at least 3-4 detailed, long paragraphs filled with analytical depth, specific statistics, and actionable observations. Aim for 250-400 words per section.\n\n"
        ...
        f"    \"Specific operational or technological challenge 2 with deep context (at least 3-4 sentences detailing the root cause and impact)\",\n"
        f"    \"Specific operational or technological challenge 3 with deep context (at least 3-4 sentences detailing the root cause and impact)\",\n"
        f"    \"Specific operational or technological challenge 4 with deep context (at least 3-4 sentences detailing the root cause and impact)\",\n"
        f"    \"Specific operational or technological challenge 5 with deep context (at least 3-4 sentences detailing the root cause and impact)\"\n"
        f"  ],\n"
        f"  \"recommendations\": [\n"
        f"    {{\"title\": \"Actionable recommendation title 1\", \"description\": \"Clear actionable implementation guide (5-6 sentences explaining the logic, steps, and expected impact)\"}},\n"
